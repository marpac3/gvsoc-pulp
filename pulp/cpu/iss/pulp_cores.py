...
class cv32e40p(cpu.iss.riscv.RiscvCommon):
    ...
    def __init__(self, parent, name, fetch_enable: bool=False, boot_addr: int=0, cluster_id: int=31, core_id: int=0,
            pulpv2: bool=True, fpu: bool=True, zfinx: bool=False, corev_cluster: bool=False, core_version: int=2,
        ...
        corev_cluster : bool
            Cluster variant (COREV_CLUSTER). Contributes to mimpid. Default False.
        core_version : int
        ...
        # mimpid = (FPU || COREV_PULP || COREV_CLUSTER) ? 1 : 0  (RTL cv32e40p_cs_registers.sv)
        mimpid = 0x1 if (fpu or pulpv2 or corev_cluster) else 0x0
